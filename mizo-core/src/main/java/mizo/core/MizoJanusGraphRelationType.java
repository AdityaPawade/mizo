 ...
 */
public class MizoJanusGraphRelationType implements Serializable, InternalRelationType, PropertyKey {
    ...
    public MizoJanusGraphRelationType(InternalRelationType relationType) {
